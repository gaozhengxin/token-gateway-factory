...
async function main() {
  ...
  console.log(`erc20GatewayFactory : ${erc20GatewayFactory}`);
  ...
  console.log(`erc721GatewayFactory : ${erc721GatewayFactory}`);
  ...
  console.log(`erc1155GatewayFactory : ${erc1155GatewayFactory}`);
  ...
  console.log(`erc677GatewayFactory : ${erc677GatewayFactory}`);
  ...
  console.log(`factoryPortal : ${factoryPortal}`);
}
